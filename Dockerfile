...
RUN /etc/init.d/postgresql start &&        psql --command "CREATE USER dborodin WITH SUPERUSER PASSWORD '12345678';" && createdb -E UTF8 -T template0 -O dborodin test && /etc/init.d/postgresql stop
